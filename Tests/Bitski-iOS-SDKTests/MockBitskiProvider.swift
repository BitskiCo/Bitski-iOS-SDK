...
class StubbedTransactionSigner: TransactionSigner {
    ...
    var lastTypedDataSignRequest: (EthereumAddress, JSON)? = nil
    ...
    override func sign<Result>(from: EthereumAddress, typedData: JSON, method: String = "eth_signTypedData", chainId: Int = 0) -> Promise<Result> where Result : Codable {
